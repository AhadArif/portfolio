                    ...
                    <div className="absolute bottom-4 right-4 flex gap-2">
                      {project.liveUrl ?? project.link ? (
                        <a
                          ...
                          className="bg-white/90 dark:bg-gray-800/90 text-gray-900 dark:text-white p-2.5 rounded-full hover:bg-gradient-to-br hover:from-blue-600 hover:to-purple-600 hover:text-white transition-all duration-300 backdrop-blur-sm shadow-lg transform hover:scale-110"
